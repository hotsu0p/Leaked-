...
class Astroz(commands.AutoShardedBot):
    ...
    async def on_connect(self):
        await self.change_presence(status=discord.Status.online, activity=discord.Activity(type=discord.ActivityType.listening,name=f"$help & $inv"))
        ...
        async with aiohttp.ClientSession(
            ...
            async with session.post(
                    "https://top.gg/api/bots/1126351590064930847/stats",
                    json={
