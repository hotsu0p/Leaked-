...
class Server(commands.Cog):
  ...
  async def _owner(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker = discord.Embed(
        description=
        f"<a:cx_tick:1158669360223748106> | Successfully Given <@&{role}> To {member.mention}",
        color=0x00FFCA)
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:no:1158411070608769034>  | Owner role is not setuped in {context.guild.name}",
        color=0x00FFCA)
  ...
  async def _coowner(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:no:1158411070608769034>  | Co Owner role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _headadmin(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:no:1158411070608769034>  | Head Admin role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _admin(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:no:1158411070608769034>  | Admin role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _girladmin(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:no:1158411070608769034>  | Girl Admin role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _headmod(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:no:1158411070608769034>  | Head Mod role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _mod(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:no:1158411070608769034> Mod role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _girlmod(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<a:no:1158411070608769034>   | Girl Mod role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def staff(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `Staff` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def girl(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `girl` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def vip(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `vip` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def guest(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `guest` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def friend(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `friend` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def owner(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `Owner` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def coowner(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `Co Owner` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def headadmin(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `Head Admin` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def admin(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `Admin` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def headmod(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `Head Mod` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def mod(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `Mod` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def girladmin(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `Girl Admin` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def girlmod(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<a:cx_tick:1158669360223748106> | Successfully Setuped `Girl Mod` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def rsta(self, context: Context) -> None:
    if data := getConfig(context.guild.id):
      ...
      embed = discord.Embed(
        ...
        color=0x00FFCA)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Staff Role:",
                      value=f"{staffr}",
                      inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Girl Role:",
                      value=f"{girlr}",
                      inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Vip Role:",
                      value=f"{vipr}",
                      inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Guest Role:",
                      value=f"{guestr}",
                      inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Friend Role:",
                      value=f"{frndr}",
                      inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Owner Role:",
                      value=f"{own}",
                      inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Co Owner Role:",
                      value=f"{coown}",
                      inline=False)
      embed.add_field(
        name="<a:cx_tick:1158669360223748106> Head Admin Role:",
        value=f"{headmin}",
        inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Admin Role:",
                      value=f"{adminss}",
                      inline=False)
      embed.add_field(
        name="<a:cx_tick:1158669360223748106> Girl Admin Role:",
        value=f"{gadminss}",
        inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Head Mod Role:",
                      value=f"{hmod}",
                      inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Mod Role:",
                      value=f"{mod}",
                      inline=False)
      embed.add_field(name="<a:cx_tick:1158669360223748106> Girl Mod Role:",
                      value=f"{gmod}",
                      inline=False)
  ...
  async def rstaff(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker = discord.Embed(
        description=
        f"<a:cx_tick:1158669360223748106> | Successfully Removed <@&{role}> From {member.mention}",
        color=0x00FFCA)
      hacker.set_author(name=f"{context.author}",
                        icon_url=f"{context.author.avatar}")
      hacker.set_thumbnail(url=f"{context.author.avatar}")
