    ...
    async def _addhumans(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role.position >= ctx.guild.me.top_role.position:
                ...
                embed = discord.Embed(
                    description=
                    "<a:no:1158411070608769034> | {} is already in human vcroles ."
                    .format(role.mention),
                    color=0x00FFCA)
                ...
                hacker = discord.Embed(
                    description=
                    "<a:cx_tick:1158669360223748106> | {} has been added to human vcroles ."
                    .format(role.mention),
                    color=0x00FFCA)
    ...
    async def _addbots(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role.position >= ctx.guild.me.top_role.position:
                ...
                embed = discord.Embed(
                    description=
                    "<a:no:1158411070608769034> | {} is already in bot vcroles ."
                    .format(role.mention),
                    color=0x00FFCA)
                await ctx.reply(embed=embed, mention_author=False)
            else:
                ...
                hacker = discord.Embed(
                    description=
                    "<a:cx_tick:1158669360223748106> | {} has been added to bot vcroles ."
                    .format(role.mention),
                    color=0x00FFCA)
                await ctx.send(embed=hacker, mention_author=False)
        else:
    ...
    async def _removehumans(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role.position >= ctx.guild.me.top_role.position:
                ...
                embed = discord.Embed(
                    description=
                    "<a:no:1158411070608769034> | {} is not in human vcroles ."
                    .format(role.mention),
                    color=0x00FFCA)
                ...
                hacker = discord.Embed(
                    description=
                    "<a:cx_tick:1158669360223748106> | {} has been removed from human vcroles."
                    .format(role.mention),
                    color=0x00FFCA)
    ...
    async def _removebots(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if role.position >= ctx.guild.me.top_role.position:
                ...
                embed = discord.Embed(
                    description=
                    "<a:no:1158411070608769034> | {} is not in bot vcroles.".
                    format(role.mention),
                    color=0x00FFCA)
                await ctx.reply(embed=embed)
            elif role.id == data["vcrole"]["bots"]:
                ...
                hacker = discord.Embed(
                    description=
                    "<a:cx_tick:1158669360223748106> | {} has been removed from bot vcroles."
                    .format(role.mention),
                    color=0x00FFCA)
                await ctx.send(embed=hacker)
        else:
    ...
    async def _reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["vcrole"]["humans"] == "" and data["vcrole"]["bots"] == "":
                embed = discord.Embed(
                    description=
                    "<a:no:1158411070608769034> | This server don't have any vcroles setupped .",
                    color=0x00FFCA)
                await ctx.send(embed=embed)
            else:
                data["vcrole"]["bots"] = ""
                ...
                hacker = discord.Embed(
                    description=
                    "<a:cx_tick:1158669360223748106> | Succesfully cleared all vcroles for this server .",
                    color=0x00FFCA)
                await ctx.send(embed=hacker)
        else:
            hacker5 = discord.Embed(
