...
Aliases""")
    ...
    async def membercount(self, ctx: commands.Context):
        ...
        embed = discord.Embed(
            ...
            description="<:s_curveup:1162651751074238524> **MemberCount <a:Saniya_ka_dil:1162651646539616316>**\n- %s members" % (len(ctx.guild.members)),
    )
    ...
    async def hack(self, ctx: commands.Context, member: discord.Member):
        ...
        embed.set_footer(
          ...
          icon_url="https://media.discordapp.net/attachments/1050050986049277973/1145686115957882880/Chill-Anime-Boy-Profile-Pic.jpg"
      )
        await ctx.send(embed=embed)
