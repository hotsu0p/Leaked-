...
class OnOrOff(BasicView):
    ...
    @discord.ui.button(label="Yes", emoji="<a:cx_tick:1158669360223748106>", custom_id='Yes', style=discord.ButtonStyle.green)
    async def dare(self, interaction, button):
        self.value = 'Yes'
        self.stop()

    @discord.ui.button(label="No", emoji="<a:no:1158411070608769034>", custom_id='No', style=discord.ButtonStyle.danger)
