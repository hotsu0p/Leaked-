        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(thumbnail_link):
                ...
                hacker = discord.Embed(
                    color=0x0d0d13,
                    description=
                    "<a:cx_tick:1158669360223748106> | Successfully updated the welcome thumbnail url .",
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if streamables.search(image_link):
                ...
                hacker = discord.Embed(
                    color=0x0d0d13,
                    description=
                    "<a:cx_tick:1158669360223748106> | Successfully updated the welcome image url .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
    ...
    async def _greet_autodel(self, ctx, *, autodelete_second):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                color=0x0d0d13,
                description=
                f"<a:cx_tick:1158669360223748106> | Successfully updated the welcome autodelete second to {autodelete_second} .\nFrom now welcome message will be deleted after {autodelete_second} .",
                timestamp=ctx.message.created_at)
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            await ctx.send(embed=hacker)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            try:
                ...
                hacker = discord.Embed(
                    color=0x0d0d13,
                    description=
                    f"<a:cx_tick:1158669360223748106> | Successfully updated the welcome message .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["embed"] == True:
                ...
                hacker = discord.Embed(
                    color=0x0d0d13,
                    description=
                    f"<a:cx_tick:1158669360223748106> | Okay, Now your embed is removed and welcome message will be a plain message .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                hacker1 = discord.Embed(
                    color=0x0d0d13,
                    description=
                    f"<a:cx_tick:1158669360223748106> | Okay, Now your embed is enabled and welcome message will be a embed message.",
                    timestamp=ctx.message.created_at)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["ping"] == True:
                ...
                hacker = discord.Embed(
                    color=0x0d0d13,
                    description=
                    f"<a:cx_tick:1158669360223748106> | Okay, Now your embed ping is disabled and users won't get pinged upon welcome .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
            ...
            if len(chh) == 1:
                ...
                if str(channel.id) in chh:
                    hacker1 = discord.Embed(
                        color=0x0d0d13,
                        description=
                        f"<a:no:1158411070608769034> | This channel is already in the welcome channels list .",
                        timestamp=ctx.message.created_at)
                    hacker1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=hacker1)
                    ...
                    hacker4 = discord.Embed(
                        color=0x0d0d13,
                        description=
                        f"<a:cx_tick:1158669360223748106> | Successfully added {channel.mention} to welcome channel list .",
                        timestamp=ctx.message.created_at)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(chh) == 0:
                hacker = discord.Embed(
                    color=0x0d0d13,
                    description=
                    f"<a:no:1158411070608769034> | This server dont have any welcome channel setupped yet .",
                    timestamp=ctx.message.created_at)
                hacker.set_author(name=f"{ctx.author.name}",
                                  icon_url=f"{ctx.author.avatar}")
                await ctx.send(embed=hacker)
                ...
                if str(channel.id) not in chh:
                    hacker1 = discord.Embed(
                        color=0x0d0d13,
                        description=
                        f"<a:no:1158411070608769034> | This channel is not in the welcome channels list .",
                        timestamp=ctx.message.created_at)
                    hacker1.set_author(name=f"{ctx.author.name}",
                                       icon_url=f"{ctx.author.avatar}")
                    await ctx.send(embed=hacker1)
                    ...
                    hacker3 = discord.Embed(
                        color=0x0d0d13,
                        description=
                        f"<a:cx_tick:1158669360223748106> | Successfully removed {channel.mention} from welcome channel list .",
                        timestamp=ctx.message.created_at)
    ...
    async def welctestt(self, ctx):
        ...
        if chan == []:
            hacker = discord.Embed(
                color=0x0d0d13,
                description=
                f"<a:no:1158411070608769034> | Oops, Kindly setup your welcome channel first .",
                timestamp=ctx.message.created_at)
            hacker.set_author(name=f"{ctx.author.name}",
                              icon_url=f"{ctx.author.avatar}")
            await ctx.send(embed=hacker)
    ...
    async def _reset(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["welcome"]["channel"] == []:
                embed = discord.Embed(
                    description=
                    "<a:no:1158411070608769034> | This server don't have any greet channel setuped yet .",
                    color=0x0d0d13)
                await ctx.send(embed=embed)
            else:
                ...
                hacker = discord.Embed(
                    description=
                    "<a:cx_tick:1158669360223748106> | Succesfully cleared all greet config for this server .",
                    color=0x0d0d13)
                await ctx.send(embed=hacker)
        else:
